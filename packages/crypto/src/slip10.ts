import { fromHex, toAscii } from "@haqqjs/encoding";
import { Uint32, Uint53 } from "@haqqjs/math";
 ...
 *
 * ```ts
 * import { stringToPath } from "@haqqjs/crypto";
 *
 ...
 *
 * ```ts
 * import { HdPath, Slip10RawIndex } from "@haqqjs/crypto";
 *
